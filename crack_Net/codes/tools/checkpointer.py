...
class Checkpointer(object):
    ...
    def save(self, obj, save_ods,saveois,tag=None, *args, **kwargs):
        ...
        if new_filename == old_filename and not self.overwrite:
            ...
            try:
                ...
                pass
        new_filename=new_filename+str(save_ods)[0:6]+"_"+str(saveois)[0:6]
        torch.save(self._get_state(obj), new_filename, *args, **kwargs)
        torch.save((self.counter, new_filename), self.chkp)
        print("save_ods:"+str(save_ods)+"  save_ois:"+str(saveois)+" weights"+tag)
